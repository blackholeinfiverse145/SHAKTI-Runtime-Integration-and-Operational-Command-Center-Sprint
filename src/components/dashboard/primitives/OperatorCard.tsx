...
export const OperatorCard = memo(function OperatorCard({
  ...
  return (
    <div className="flex items-start gap-3 p-2.5 rounded-lg border border-slate-700/50 bg-slate-800/40">
      ...
      <div className="flex-1 min-w-0">
        ...
        {currentAssignment && (
          <div className="mt-1.5 flex items-center gap-1.5 text-[10px] text-slate-500 bg-slate-900/50 p-1 rounded line-clamp-1">
